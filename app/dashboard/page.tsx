...
export default function Dashboard() {
  ...
  return <main className="dashboard-page">
    <header className="topbar"><div><span className="brand">HOVERBOARD</span><span className="muted"> · {role === "dj" ? "DJ" : "Client"} Dashboard</span></div><div className="topbar-actions"><Link className="button" href="/requests">Requests</Link><Link className="button" href="/messages">Messages</Link>{role === "dj" && <Link className="button" href="/connect">DJ payouts</Link>}<Link className="button primary" href="/discover">{discoveryLabel}</Link>{role === "client" && <Link className="button primary" href="/gigs/new">Make a gig</Link>}{role === "dj" && <Link className="button" href="/profile">Edit profile</Link>}<button onClick={logout}>Log out</button></div></header>
